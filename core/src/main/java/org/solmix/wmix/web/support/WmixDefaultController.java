...
import org.solmix.wmix.web.exchange.WmixPhasePolicy;
import org.solmix.wmix.web.exchange.WmixProtocolFactory;
import org.solmix.wmix.web.exchange.WmixServiceFactory;
import org.solmix.wmix.web.servlet.ServletContextResourceResolver;
import org.solmix.wmix.web.transporter.ServletTransporter;
...
public class WmixDefaultController extends AbstractEndpointFactory implements Controller
{
    ...
    private static final String TRANSPORTER_ID = "http://transport.solmix.org/http/servlet";

    private Component component;

    private Container container;

    private WmixServiceFactory serviceFactory;
    ...
    public void setContainer(Container container) {
        ...
        getServiceFactory().setContainer(container);
    }
    ...
    protected Endpoint createEndpoint() throws EndpointException {
        ...
        ep.put(WmixServiceFactory.class.getName(), serviceFactory);
        return ep;
    }
    ...
    public WmixServiceFactory getServiceFactory() {
        if (serviceFactory == null) {
            serviceFactory = new WmixServiceFactory();
        }
        return serviceFactory;
    }

    public void setServiceFactory(WmixServiceFactory serviceFactory) {
