...
public interface Request {
    ...
    /**
     * Returns the Rest portion of the request path.
     * <p>
     * If incoming request is http://mydomain.com/api/myresource/test?q=test and baseUri is http://mydomain.com/api,
     * then Rest path will be /myresource/test
     * </p>
     *
     * @return the Rest portion of the request path.
     */
    String getRestPath();


    /**
     * Returns the Rest portion of the webRoot  physical path.
     *
     * @param path webRoot relative path
     * @return the Rest portion of the  webRoot  physical path.
     */
    String getRealPath(String path);

    /**
     * Returns the Rest portion of the full request uri.
     * <p>
     * If incoming request is http://mydomain.com/api/myresource/test?q=test and baseUri is http://mydomain.com/api,
     * then Rest uri will be /myresource/test?q=test
     * </p>
     *
     * @return the Rest portion of the full request uri.
     */
    String getRestUri();
