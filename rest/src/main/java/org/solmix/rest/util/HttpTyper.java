...
public class HttpTyper {
    ...
    static {
        ...
        for (String prop : mimeType.stringPropertyNames()) {
            Iterable<String> types = Arrays.asList(mimeType.getProperty(prop));
    ...
    public static String headerTokenCompatible(String s, String specialCharsReplacement) {
        Assert.assertNotNull(specialCharsReplacement.replaceAll(RFC_2616_TOKEN_SPECIAL_CHARS_REGEX, "blah").equals(specialCharsReplacement),
